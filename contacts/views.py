...
def inquiry(request):
    if request.method == 'POST':
        ...
        contact = Contact(car_id=car_id, car_title=car_title, user_id=user_id, last_name=last_name,
                          first_name=first_name, customer_need=customer_need, city=city, state=state, email=email,
